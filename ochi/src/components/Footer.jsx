...
function Footer() {
  return (
    <div className='flex gap-5 w-full h-screen bg-zinc-900  p-20 font-["Founders_Grotesk__X-Condensed"]'>
        <div className='w-1/2 flex h-full flex-col justify-between  '> 
        <div className='heading'>

        <h1 className='text-[7vw] font-semibold uppercase leading-none -mb-8' >EYE-</h1> 
       ...
       <div className='w-1/2  '>
        <h1 className='text-[5vw] font-semibold uppercase leading-none -mb-8' >PRESENTATIONS</h1>
           <div className='dets font-["Neue_Montreal"] mt-20  '>
            <a className="block text-2xl font-light underline" href='https://www.facebook.com/'>Facebook</a>
            <a className="block text-2xl font-light underline" href='https://www.instagram.com/?hl=en'>Instagram</a>
            <a className="block text-2xl font-light underline" href='https://x.com/?lang=en'>Twitter</a>
             <a className='block text-2xl font-light underline' href="https://www.behance.net/ ">Behance</a>
          </div> 


          <div className='dets font-["Neue_Montreal"] mt-20'>
            <a className="block text-2xl font-light underline" >202-1965 W 4th Ave</a>
            <a className="block text-2xl font-light underline" >Vancouver, Canada</a>
            <a className="block text-2xl font-light underline" >30 Chukarina St</a>
             <a className='block text-2xl font-light underline' >Lviv, Ukraine</a>
          </div> 


          <div className='dets font-["Neue_Montreal"] mt-20'>
            <a className="block text-2xl font-light underline">https://ochi.design/</a>
